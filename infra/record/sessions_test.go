...
var (
	sessionDBTypes = map[string]string{`CreatedAt`: `timestamp without time zone`, `ID`: `bigint`, `SecretKey`: `character varying`, `UpdatedAt`: `timestamp without time zone`, `UserID`: `bigint`}
	_              = bytes.MinRead
)
